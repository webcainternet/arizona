...
<head>
    ...
    $.src="https://v2.zopim.com/?4QX1lsMvWQd9ZdIMFXNKyGQrNGsMWRTU";z.t=+new Date;$.
...
<body id="page-top">
    ...
    <!-- Planos - Conecta+ com ligação local e DDD ilimitado -->
    <section class="bg-primary1" id="about1">
        <div class="container">
            <div class="row">
    ...
    <!-- Planos - Conecta+ com ligação local ilimitada -->
    <section class="bg-primary2" id="about2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
    ...
    <!-- Planos - Conecta100 -->
    <section class="bg-primary3" id="about3">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Conecta100</h2>
                    <hr class="light">
...
<div class="adv"  id="vantagens">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                            ...
                            <div class="row">
                                <div class="col-md-8" style="text-align: justify;">
                                    ...
                                    <div class="cc-store-buttons">
                                        ...
                                        <div class="col-md-6">
                                            <a href="https://itunes.apple.com/br/app/conecta-center/id698342127?mt=8" target="_blank"><img src="img/apple-store.png" alt="Baixe no Apple Store"></a>
                                        </div>
                                    </div>
                                    <br>&nbsp;
                                    <p><b>Simplicidade</b> e <b>transparência</b> em suas mãos</p>
                                    <p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 text-left">
                            Desconto no Seguro de seu veículo
                        </div>
    ...
    <section id="contact" class="footerdiv">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 text-left">
                    <ul class="sem-bullet linkcinza">
                        <li><a class="page-scroll" href="#about1">Conecta+ com ligação local e DDD ilimitado</a></li>
                        <li><a class="page-scroll" href="#about2">Conecta+ com ligação local ilimitada</a></li>
                        <li><a class="page-scroll" href="#about3">Conecta100 minutos</a></li>
                    </ul>
                </div>
                <div class="col-lg-3 text-left">
    ...
    <section id="direitos" class="direitos">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-left">
